...
#SBATCH --output=../runlogs/PA_Clang_C-API_DP-OPS_No-Mltpx_VariabilityStudyRunData.log
#SBATCH --open-mode=truncate
#SBATCH --ntasks=1
#SBATCH --time=2:00:00
#SBATCH --export=ALL

DATA_DIR_NAME="PA_Clang_C-API_DP-OPS_No-Mltpx"
SUFFIX="lulesh"
BLIM=0
CLIM=0
MAX_POL=1
...
for P in $(seq 0 $MAX_POL); do
    ...
    APOLLO_PERF_CNTRS_MLTPX=$ENABLE_PERF_CNTRS_MLTPX \
...
ROOT_DATA_DIR=~/workspace/lulesh-region-fix-correct/LULESH/runData
